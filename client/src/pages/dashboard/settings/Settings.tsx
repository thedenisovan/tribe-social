...
export default function Settings() {
  ...
  return (
    <main className='p-5 *:border *:p-2 *:rounded-xl h-full gap-5 flex flex-col *:dark:bg-neutral-700/30 *:dark:border-neutral-700 *:border-neutral-300 *:bg-neutral-100/40 main-w'>
      ...
      <section className='flex-1 max-w-300! '>
        <form
          onSubmit={(e) => e.preventDefault()}
          className=' flex flex-col gap-8 text-gray-900 dark:text-gray-100'
        >
          {/* Profile Section */}
          <div className='p-6 rounded-xl space-y-5'>
            ...
            <div className='grid gap-4'>
              <input
                ...
                disabled
                className='w-full px-3 py-2 rounded-lg border bg-gray-100 dark:bg-gray-800 border-gray-300 dark:border-gray-700 cursor-not-allowed'
              />
              ...
              <textarea
                ...
                maxLength={200}
                placeholder='Bio'
                className='w-full px-3 py-2 rounded-lg border bg-white dark:bg-gray-950 border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-purple-500 outline-none resize-none'
              />
      ...
      <footer className=''>
        <p className='text-sm text-neutral-500 dark:text-neutral-200'>
          ...
          fields you want to update. Leave fields unchanged to keep your current
          settings.
        </p>
      </footer>
    </main>
