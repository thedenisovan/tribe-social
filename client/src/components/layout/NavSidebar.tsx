...
export default function Sidebar() {
  ...
  return (
    <aside className='h-full lg:w-70 fixed border-r p-4 dark:border-neutral-800 border-neutral-200'>
      <nav>
        <ul className='flex flex-col gap-7'>
          ...
          <li
            className={`hover:dark:bg-purple-900/40 p-1 hover:bg-purple-900/10 rounded-lg ${currentPageStyle('Notifications')}`}
          >
            <Link
              className='flex items-center gap-2'
              to={'/dashboard/notifications'}
            >
              <NavIcons path='M160-200v-80h80v-280q0-83 50-147.5T420-792v-28q0-25 17.5-42.5T480-880q25 0 42.5 17.5T540-820v28q80 20 130 84.5T720-560v280h80v80H160Zm320-300Zm0 420q-33 0-56.5-23.5T400-160h160q0 33-23.5 56.5T480-80ZM320-280h320v-280q0-66-47-113t-113-47q-66 0-113 47t-47 113v280Z' />
              <p className='font-medium hidden md:block text-neutral-600 dark:text-neutral-300/90'>
                Notifications
              </p>
            </Link>
          ...
          >
            <Link
              className='flex items-center gap-2'
              to={`/dashboard/profile/${localStorage.getItem('uid')}`}
            >
